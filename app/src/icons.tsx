...
export const QrIcon = (p: P) => (
  <svg {...base(p)}>
    ...
    <path d="M14 14h3v3h-3zM20 14h1M14 20h1M20 20h1M17 17h4v4" />
  </svg>
);
...
export const EyeOffIcon = (p: P) => (
  <svg {...base(p)}>
    <path d="M17.9 17.9A10.9 10.9 0 0 1 12 19c-7 0-11-7-11-7a20 20 0 0 1 5.1-5.9M9.9 4.2A10.9 10.9 0 0 1 12 5c7 0 11 7 11 7a20 20 0 0 1-3.2 4.2" />
